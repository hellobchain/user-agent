			...
			if engine.name == "AppleWebKit" {
				...
				default:
					...
					case "MicroMessenger":
						...
						p.browser.Version = sections[slen-3].version
					case "MacWechat", "WindowsWechat", "LinuxWechat":
						p.browser.Name = "微信客户端浏览器"
						p.browser.Version = sections[slen-3].version
					default:
						...
						default:
							...
							case "Chrome", "CriOS":
								p.browser.Name = "谷歌浏览器"
							case "HeadlessChrome":
								p.browser.Name = "无界面的谷歌浏览器"
							case "Chromium":
								p.browser.Name = "谷歌网页浏览器"
							case "GSA":
								p.browser.Name = "谷歌 App"
							case "FxiOS":
								p.browser.Name = "火狐浏览器"
							default:
								p.browser.Name = "苹果浏览器"
							}
						}
					}
